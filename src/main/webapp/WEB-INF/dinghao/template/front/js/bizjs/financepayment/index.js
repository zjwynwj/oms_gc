...
$(function() {
	...
	datatype : "json",
	url : base_template + '/finance_payment/get_finance_payments.jhtml',
	mtype : 'POST',
	forceFit : true,
...
function childAdd() {
    var url = base_template + "/finance_payment/add_financepayment.jhtml";
    artTabs({
	addTab : {
	    items : {
		id : 'add_financepayment',
		title : '新增付款单',
		url : url
	    }
	}
...
function updateButtom(id) {
    var url = base_template + "/finance_payment/update_financepayment.jhtml?id=" + id;
    artTabs({
	addTab : {
	    items : {
		id : 'update_financepayment',
		title : '修改付款单',
		url : url
	    }
	}
...
function viewButtom(id) {
    var url = base_template + "/finance_payment/view_financepayment.jhtml?id=" + id;
    artTabs({
	addTab : {
	    items : {
		id : 'view_financepayment',
		title : '查看付款单',
		url : url
	    }
	}
