...
$(function() {
    ...
    jQuery("#blackId").jqGrid({
        datatype: "json",
        url: base_template + '/receipt/get_receipt_details.jhtml?receiptType=2&receiptId=' + $("input[name='id']").val(),
        mtype: 'POST',
        colNames: ['序号', 'gdsInfoId', 'receiptId', '操作', '商品编号 ','商品名称','规格代码','规格名称', '属性', '单位', '数量', '库位编码', '库位编码id', '备注'],
        colModel: [
        ...
        {name: 'amount',index: 'amount', editable: true,width:60 },
        {
            ...
            width: 200,
            formatter: function(cellvalue, options, rowObject) {
                return "<input value='" + cellvalue + "' width='200px' class='bindSelect' name='warehousePositionsName' id=warehousePositionsName_" + options.rowId + ">";
            }
        },
        {
...
$('#myForm').ajaxForm({
    ...
    success: function(data) {
        if (data.result) {
            ...
            receiptDetailVos["receiptType"] = 2;
