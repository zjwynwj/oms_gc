		...
		<form id="addPic" action="${BASE_PATH_TEMPLATE}/gdsMgr/goodsImgUpLoadFile.jhtml" method="post" enctype="multipart/form-data">
			<div class="m-detail-con f-clearfix">
				<div class="m-toolbar f-mb15 f-clearfix">
					<ul class="search-con f-fl" style="display:none">
			        	<input type="button" class="u-btn u-btn-auto u-btn-bg-blue" value="分享">
			        </ul>
			        <ul class="search-con f-fr">
			        	<input type="button" onclick="uploadsImg()" class="u-btn u-btn-auto u-btn-bg-blue" value="保存">
			        </ul>
			      </div>
			    <div class="m-content">
					<h4 class="m-title">基本信息</h4>
					<ul class="m-message-list f-mb10 f-clearfix">
			            <li><label>商品编号:</label><input type="text" class="u-ipt u-ipt-nm u-ipt-disabled" placeholder="输入内容" id="gdsNo" disabled=""/></li>
			             <li><label>成分:</label><input type="text" class="u-ipt u-ipt-nm"  id="ingredient"/></li>
			            <li>
			            	<label><i class="requeid">*</i>商品名称:</label>
			            ...
			            <li>
			            	<label>单位:</label>
			            	<select id="cal"  class="u-select u-select-nm">
			            ...
			            <li><label>销售价(元):</label><input type="text" class="u-ipt u-ipt-nm" placeholder="输入内容" id="gdsSelPrice" realMoney/></li>
			        	...
			        	<li><label>克重gsm:</label><input type="text" class="u-ipt u-ipt-nm" placeholder="输入内容" id="standWeight" amountFlag/>克/平方米</li>
			             <li><label>纱支yarn count:</label><input type="text" class="u-ipt u-ipt-nm" placeholder="输入内容" id="artNo" amountFlag/></li>
		                <li><label>门幅width:</label><input type="text" class="u-ipt u-ipt-nm" placeholder="输入内容" id="generatePact" /></li>
			         </ul>
					...
					<ul class="m-message-list f-mb10 f-clearfix">
			            <li><label>最低库存:</label><input type="text" class="u-ipt u-ipt-nm" placeholder="输入内容" id="gdsLowAmount" amountFlag/></li>
			            <li><label>最高库存:</label><input type="text" class="u-ipt u-ipt-nm" placeholder="输入内容" id="gdsHighAmount" amountFlag/></li>
			        </ul>
	...
	<script	src="${BASE_PATH}/dinghao/template/front/js/bizjs/goods/gdsMgr/modGdsInfo.js?v=${config_front}"></script>	
</html>