			...
			<div class="m-form-tit f-mb20 f-clearfix">
				...
				<ul class="m-form-grd-rt">
				     <#if receipt.receiptCode==null  >
					   <li><a href="javascript:void(0);" id="save"  class="u-btn save u-btn-auto u-btn-bg-blue">确认</a></li>
				     </#if>
				</ul>
				<h4>入库单</h4>
			</div>
			<div class="m-toolbar f-mb15 f-clearfix">
					...
					<ul class="search-con">
						...
						<input id="providerId" type="hidden" autocomplete="off" name="providerId" class="u-ipt u-ipt-nm" value="${receipt.providerId}" /> 
							<input id="remarks" name="remarks" type="text" class="u-ipt u-ipt-nm" value="${receipt.remarks}" /></li>
...
<script src="${BASE_PATH}/dinghao/template/front/js/bizjs/receipt/add.js?v=${config_front}"></script>
</html>W
