				...
				<section class="panel">
					...
					<div class="panel-body">
						<form id="add_form" method="post" class="form-horizontal"
							autocomplete="off" action="${BASE_PATH}/manage/role/addJson.jhtml">
							<fieldset>
...
<script type="text/javascript"
	src="${BASE_PATH}/dinghao/manage/js/htmljs/role/add.js?v=${config_v}"></script>
