			...
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading">
						<i class="icon-home"></i> 所有会员列表
						<div style="float: right;">
							<a class="btn btn-primary"
								href="${BASE_PATH}/manage/templateadmin/add.jhtml"><i
								class="icon-plus"></i>&nbsp;新增会员</a>
						</div>
					</header>
								...
								<table class="table table-striped table-advance table-hover">
									...
									<tbody role="alert" aria-live="polite" aria-relevant="all">
										...
										<tr class="gradeA odd">
											...
											<td><a
												href="${BASE_PATH}/manage/templateadmin/update.jhtml?id=${e.id}"
...
<script
	src="${BASE_PATH}/dinghao/manage/js/htmljs/templateadmin/manage.js?v=${config_v}"></script>
