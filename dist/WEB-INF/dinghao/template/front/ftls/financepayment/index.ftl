		...
		<div class="m-toolbar f-mb15 f-clearfix">
			<ul class="search-con f-fl">
				<li><a onClick="childAdd();" href="javascript:"
					id="addReceipt"
					class="u-btn u-btn-auto u-btn-bg-blue u-bd-color-blue">新增付款单</i></a></li>
				<li><label>业务日期:</label>
					<div class="date">
				...
				<li><label>单据号</label><input name="payNo" id="payNo"
...
<script type="text/javascript"
	src="${BASE_PATH}/dinghao/template/front/js/bizjs/financepayment/index.js?v=${config_front}"></script>
</html>
</#escape>
