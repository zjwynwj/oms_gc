	...
	<body>
		<div class="m-detail-con f-clearfix">
			<form id="addPic" action="${BASE_PATH_TEMPLATE}/printMgr/templateImgUpLoadFile.jhtml" enctype="multipart/form-data" method="post" >
				...
				<input type="hidden"  id="logisIdVal" value="${logisId}" />
				<input type="hidden"  id="logisNameVal" value="${logisName}" />
				<div class="m-toolbar f-mb15 f-clearfix">
					<ul class="search-con f-fl">
		 			    <li>
							<label style="float:left;width:auto;">模板名称：</label>
							<input type="text"   class="u-ipt u-ipt-nm"  value="${printTemplate.name}" id='templateName'/>
						</li> 
						<li>
							<label style="float:left;width:auto;">快递公司：</label>
							<select name="logisId" id="logisId" class="u-select u-select-nm"  disabled>
	                  	  	</select>
						</li>
						<!--<li class="f-mr10">
							<label>类型：</label>
							<select  class="u-select u-select-nm"  name="type" id="type" value="1"  disabled>
						...
						<li>
							...
							<select  class="u-select u-select-nm" style="width:120px;" name="templateSize" id="templateSize" onchange="setTemplateSize(this.value);" value="230:137">
						...
						<li>
							...
							<input style="float:left;width:60px;" name="template_width" class="u-ipt u-ipt-nm"  id="template_width" type="text" value="230" />
							<input style="float:left;width:60px;" name="template_height" class="u-ipt u-ipt-nm" id="template_height" type="text" value="126">
							<label style="float:left;width:auto;">mm</label>
							
						</li>
						<li>
								<input value="保存模板" type="button" onclick="doModSubmit()" class="u-btn u-btn-bg-blue u-btn-auto" />
					</li>
	...
	<script	src="${BASE_PATH}/dinghao/template/front/js/bizjs/express/printTemplateMod.js?v=${config_front}"></script>
</html>