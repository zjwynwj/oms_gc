		...
		<div class="m-toolbar f-mb15 f-clearfix">
			<ul class="search-con f-fl">
				<li><a onClick="childAdd();" href="javascript:"
					id="addReceipt"
					class="u-btn u-btn-auto u-btn-bg-blue u-bd-color-blue">新划拨款单</i></a></li>
				<li><label>业务日期:</label>
					<div class="date">
				...
				<li style="display:none"><label>往来单位</label><input name="remarks" id="custName"
...
<script type="text/javascript"
	src="${BASE_PATH}/dinghao/template/front/js/bizjs/financetransfer/index.js?v=${config_front}"></script>
</html>
</#escape>
