		...
		<div class="m-detail-con f-clearfix">
		    <div class="m-form-tit f-mb20 f-clearfix">
				     <ul class="m-form-grd-lt">
				         <input type="hidden" id="suggestGoodsids" value="${suggestGoodsids}">
		        ...
		        <div class="m-toolbar f-mb15 f-clearfix">
				        <ul class="search-con">
				             <li>
				            	<label style = "float:left;width:auto;" >供应商：</label> 
				            	<input id="remarks" width="200px"	name="remarks" class="u-ipt u-ipt-nm " value=${purSuggestGoods.supplierName} >
				            	<input id="providerId" type="text" name="providerId" hidden="true" value=${purSuggestGoods.supplierId}>
			            	</li>
			            ...
			            <ul class="search-con">
							<li>
								...
								<input type="text" class="u-ipt u-ipt-nm u-ipt-disabled"  placeholder="订单金额" id="payMoney" readonly=true value="0.00" realMoney style="TEXT-ALIGN:right"/>
							</li>
							<li>
	...
	<script	src="${BASE_PATH}/dinghao/template/front/js/bizjs/purchase/purOrder/addPurOrder.js?v=${config_front}"></script>	
</html>